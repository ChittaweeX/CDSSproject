...
@section('maincontent')
  ...
  <section class="content">
    <div class="row">
      <div class="col-sm-12">
        <div class="box">
          <form role="form" action="{{ url('function/symptom3') }}" method="post">
          ...
          <div class="box-body text-center">
            <div class="col-md-8 col-md-offset-2">
              ...
              <h3><strong>Does the patient has Local edema?</strong></h3>
                ...
                <hr>
                <h3><strong>Acute renal failure?</strong> </h3>
                <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group">
                      <div class='radio-inline'>
                        <label>
                          <input type='radio' name='Acute_renal' value='1' required {{ $treatmentdata->indoor == 1 ? 'checked' : '' }}>
                          <h1>Yes</h1>
                        </label>
                      </div>
                      <div class='radio-inline'>
                        <label>
                          <input type='radio' name='Acute_renal' value='0'  {{ $treatmentdata->indoor == 0 ? 'checked' : '' }}>
                          <h1>No</h1>
                        </label>
                      </div>
                    </div>
